...
public class SeleccionVehiculo extends Pantalla {
    ...
    public void start(Stage stage) {
        ...
        Button botonAuto = (new BotonVehiculo(stage, "auto", controlador)).getBoton();
        ...
        Button botonMoto = (new BotonVehiculo(stage, "moto", controlador)).getBoton();
        ...
        Button botonCamioneta = (new BotonVehiculo(stage, "camioneta", controlador)).getBoton();
